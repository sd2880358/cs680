...
class ElementKindBasedComparatorTest {
    ...
    @Test
    public void elementBaseTestCode(){
        ElementKindBasedComparator test = new ElementKindBasedComparator();
        LinkedList<ApfsElement> children = code.getChildren(test);
    ...
    @Test
    public void elementBaseTestHome(){
        ElementKindBasedComparator test = new ElementKindBasedComparator();
